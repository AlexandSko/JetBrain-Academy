...
See also: https://en.wikipedia.org/wiki/Hangman_(game)
...
The gameplay looks like:
    ...
    4) If there's no such letter in the word and this letter hasn't been tried before, the computer counts it as a miss.
       
       A player can afford only up to 8 misses before the game is over;
